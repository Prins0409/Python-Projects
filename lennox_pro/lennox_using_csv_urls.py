...
def write_output(data):
	with open('lennox_using_csv_urls.csv', mode='a',newline="", encoding="utf-8") as output_file:
...
def fetch_data():
    ...
    for data in open("lennox_all_page_url.csv",'r',encoding='utf-8'):
        all_urls = data.strip()
        headers1 = {
        ...
        response1 = requests.request("GET", all_urls, headers=headers1, proxies=proxies)
